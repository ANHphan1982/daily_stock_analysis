      ...
      >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <input
                  ...
                  disabled={isDeleting}
                  aria-label="Chọn tất cả lịch sử đã tải"
                ...
                />
                <span className="text-[11px] text-muted-text select-none">Chọn tất cả</span>
              </label>
              <Button
        ...
        {isLoading ? (
          ...
          <DashboardStateBlock
            ...
            description="Sau khi hoàn thành phân tích đầu tiên, kết quả gần đây sẽ được lưu tại đây."
            icon={(
          ...
          <div className="space-y-2">
            ...
            {!hasMore && items.length > 0 && (
              <div className="text-center py-5">
                ...
                <span className="text-[10px] text-muted-text/50 uppercase tracking-[0.2em]">Đã đến cuối</span>
              </div>
            )}
          </div>
        )}
